  ...
  <div class="container">
    ...
    <div class="table-container">
      <el-table ref="Table1"
                ...
                style="width: 100%;"
                border>
        <el-table-column label="等级" align="center"  width="50px">
